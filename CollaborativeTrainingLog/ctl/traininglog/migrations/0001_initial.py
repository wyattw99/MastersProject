# Generated by Django 4.2.7 on 2024-03-21 02:49
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name="Athlete",
            fields=[
                ("athleteId", models.BigAutoField(primary_key=True, serialize=False)),
                ...
                (
                    "trainingGroups",
                    models.ManyToManyField(
                        related_name="athletes", to="traininglog.traininggroups"
                    ),
                ),
                (
                    "user",
